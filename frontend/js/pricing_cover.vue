            ...
            template(v-for="x in squares")
                template(v-for="y in squares")
                    Box(v-for="z in squares" :position="[x, y, z]" :key="`${x},${y},${z}`")
                        ...
                        Animation(property="rotation.x" :duration="38" :end="Math.PI * 2" :loop="true")
                        Animation(property="rotation.y" :duration="38" :end="Math.PI * 2" :loop="true")
                        Animation(property="rotation.z" :duration="38" :end="Math.PI * 2" :loop="true")
                        Animation(property="scaling.x" :duration="0" :start="1.9" :end="1.9" :loop="false")
                        Animation(property="scaling.y" :duration="0" :start="1.9" :end="1.9" :loop="false")
                        Animation(property="scaling.z" :duration="0" :start="1.9" :end="1.9" :loop="false")
